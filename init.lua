...
vim.keymap.set('n', '<leader>pv', function() require('mini.files').open() end, { desc = 'File explorer' })
vim.keymap.set('n', '<leader>pf', function() require('mini.files').open(vim.api.nvim_buf_get_name(0)) end,
  { desc = 'File explorer (current file)' })
vim.keymap.set('n', '<leader>pc', function() require('mini.files').open(vim.fn.getcwd()) end,
...
vim.keymap.set('n', '<leader>lf', function() vim.lsp.buf.format({ async = true }) end, { desc = 'LSP: Format buffer' })
...
vim.keymap.set('n', '<leader>bb', function() require('buffer_manager.ui').toggle_quick_menu() end,
  { desc = 'Buffer manager' })
...
-- Flash keymaps
vim.keymap.set({ 'n', 'x', 'o' }, 'z', function() require('flash').jump() end, { desc = 'Flash: Jump' })
